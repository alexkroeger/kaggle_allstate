...
data$cont1.1 <- ((as.numeric(data$cont1 > 0.6))*data$cont1)-0.6

data$cont13.1 <- ((as.numeric(data$cont13 > 0.5))*data$cont13)-0.5

data$cont14.1 <- ((as.numeric(data$cont14 > 0.25))*data$cont14)-0.25
data$cont14.2 <- ((as.numeric(data$cont14 > 0.3))*data$cont14) - 0.3
